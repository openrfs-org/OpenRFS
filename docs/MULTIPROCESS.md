...
Trait OS can hold up to four user processes and schedule them cooperatively.

## Process state

Trait OS holds up to four user processes at once. Each owns:
...
- `include/trait/multiprocess.h` and `src/kernel/multiprocess.c` hold the

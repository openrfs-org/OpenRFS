...
Phipia is a bounded five-application workspace with a menu bar,
native 3D Dock, movable overlapping windows, Settings, Store, Files, Notes,
and Terminal. Native processes may additionally own

...
OpenGAT keeps the lightweight desktop as an optional graphical session. A
...
- **Terminal** exposes the OpenGAT command line and measured userland commands.
- **Task Manager** shows a bounded process list.
- **OpenGAT Desktop Settings** changes settings implemented by this desktop.
- **OpenGAT DE Package Manager** requests package operations; signature,
...
The default uses the supplied OpenGAT G mark, a grey wallpaper, and a restrained

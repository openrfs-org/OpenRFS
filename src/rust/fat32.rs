...
//! Checked parsing primitives for OpenGAT's bounded FAT32 subset.
...
/// Parse one entry in OpenGAT's bounded directory subset.
///
...
mod tests {
    ...
    fn boot() -> [u8; 512] {
        ...
        bytes[3..11].copy_from_slice(b"OPENGAT ");
        ...
        bytes[71..82].copy_from_slice(b"OPENGATDATA");

...
//! Checked parsing primitives for OpenRFS's bounded FAT32 subset.
...
/// Parse one entry in OpenRFS's bounded directory subset.
///
...
mod tests {
    ...
    fn boot() -> [u8; 512] {
        ...
        bytes[3..11].copy_from_slice(b"OPENRFS ");
        ...
        bytes[71..82].copy_from_slice(b"OPENRFSDATA");

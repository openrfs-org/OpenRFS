...
//! Checked parsing primitives for Trait OS's bounded FAT32 subset.
...
/// Parse one entry in Trait OS's bounded directory subset.
///
...
mod tests {
    ...
    fn boot() -> [u8; 512] {
        ...
        bytes[3..11].copy_from_slice(b"TRAITOS2");
        ...
        bytes[71..82].copy_from_slice(b"TRAITDATA  ");

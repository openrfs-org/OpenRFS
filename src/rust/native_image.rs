...
//! Safe validators for the OpenGAT application manifest and static ELF64 image.
...
const PAGE: u64 = 4096;
const MANIFEST_MAGIC: &[u8; 8] = b"OPENGAT1";
...
mod tests {
    ...
    fn manifest() -> [u8; MANIFEST_BYTES] {
        ...
        bytes[..8].copy_from_slice(b"OPENGAT1");
    ...
    fn manifest_accepts_printable_url_argument() {
        ...
        let url = b"http://opengat.test/welcome.txt\0";

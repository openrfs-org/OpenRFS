...
// `heap_free` accepts exactly those pointers. OpenGAT serializes kernel entry
...
pub(crate) fn ext4_block_write(context: usize, start_byte: u64, source: &[u8]) -> bool {
    ...
    unsafe {
        opengat_ext4_block_write(context, start_byte, source.as_ptr(), source.len()) == 0
    }
}
...
pub(crate) fn ext4_block_flush(context: usize, boundary: u32) -> bool {
    unsafe extern "C" {
        fn opengat_ext4_block_flush(context: usize, boundary: u32) -> i32;
    }
    ...
    unsafe { opengat_ext4_block_flush(context, boundary) == 0 }
}
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_mount(
    context: usize,
    media_bytes: u64,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_prepare_unmount(mounted: usize) -> i32 {
    if mounted == 0 {
        return ext4::Status::NullArgument as i32;
    }
...
/// this call. The mount remains live regardless of the result.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_sync(mounted: usize) -> i32 {
    if mounted == 0 {
        return ext4::Status::NullArgument as i32;
    }
    // SAFETY: unique access and provenance are the function contract.
...
///
/// # Safety
/// `mounted` must be a live value returned by `opengat_ext4_mount`, and
/// `free_bytes` must name one writable `u64` that does not overlap it.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_free_bytes(
    mounted: usize,
    free_bytes: *mut u64,
) -> i32 {
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_unmount(mounted: usize) -> i32 {
    if mounted == 0 {
        return ext4::Status::NullArgument as i32;
    }
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_stat(
    mounted: usize,
    path: *const u8,
    path_length: usize,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_pread(
    mounted: usize,
    path: *const u8,
    path_length: usize,
    offset: u64,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_transaction_probe(
    mounted: usize,
    path: *const u8,
    path_length: usize,
    offset: u64,
...
/// mounted object.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_truncate_probe(
    mounted: usize,
    path: *const u8,
    path_length: usize,
    size: u64,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_create_file_probe(
    mounted: usize,
    path: *const u8,
    path_length: usize,
    mode: u16,
...
/// hold a writable storage lease.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_unlink_file_probe(
    mounted: usize,
    path: *const u8,
    path_length: usize,
) -> i32 {
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_link_file_probe(
    mounted: usize,
    source: *const u8,
    source_length: usize,
...
/// hold a writable storage lease.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_create_directory_probe(
    mounted: usize,
    path: *const u8,
    path_length: usize,
) -> i32 {
...
/// hold a writable storage lease.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_remove_directory_probe(
    mounted: usize,
    path: *const u8,
    path_length: usize,
) -> i32 {
...
/// object. C must hold a writable storage lease.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_rename_probe(
    mounted: usize,
    source: *const u8,
    source_length: usize,
    destination: *const u8,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_ext4_directory_entry(
    mounted: usize,
    path: *const u8,
    path_length: usize,
    index: u64,
...
/// The Makefile points `OPENGAT_LOGO_BLOB` at it; there is no committed copy.
static LOGO: &[u8] = include_bytes!(env!("OPENGAT_LOGO_BLOB"));

/// The deterministic RGB565 wallpaper collection built from committed PNGs.
static WALLPAPER: &[u8] = include_bytes!(env!("OPENGAT_WALLPAPER_BLOB"));

/// Run the SPW3 decoder's production-asset and bounded refusal checks.
#[unsafe(no_mangle)]
pub extern "C" fn opengat_wallpaper_self_test() -> i32 {
    i32::from(wallpaper::self_test(WALLPAPER))
}

/// Return the exact byte length of the built-in SPW3 collection.
#[unsafe(no_mangle)]
pub extern "C" fn opengat_wallpaper_size() -> usize {
    WALLPAPER.len()
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_wallpaper_geometry(
    width: *mut u32,
    height: *mut u32,
    frames: *mut u32,
) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_wallpaper_decode(
    frame: u32,
    out: *mut u32,
    out_pixels: usize,
    out_width: u32,
...
#[unsafe(no_mangle)]
pub extern "C" fn opengat_logo_self_test() -> i32 {
    i32::from(logo::self_test())
}

/// How many bytes the built-in image occupies.
#[unsafe(no_mangle)]
pub extern "C" fn opengat_logo_size() -> usize {
    LOGO.len()
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_logo_geometry(width: *mut u32, height: *mut u32) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_logo_decode(
    out: *mut u32,
    out_pixels: usize,
    red_shift: u8,
    green_shift: u8,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_logo_decode_alpha(
    out: *mut u8,
    out_pixels: usize,
) -> i32 {
    if out.is_null() {
...
/// time. The Makefile points `OPENGAT_FONT_BLOB` at it; there is no committed
/// copy of the blob, only the ASCII art it is built from.
static FONT: &[u8] = include_bytes!(env!("OPENGAT_FONT_BLOB"));
...
#[unsafe(no_mangle)]
pub extern "C" fn opengat_font_self_test() -> i32 {
    i32::from(font::self_test())
}

/// How many bytes the built-in glyph table occupies.
#[unsafe(no_mangle)]
pub extern "C" fn opengat_font_size() -> usize {
    FONT.len()
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_font_geometry(
    width: *mut u32,
    height: *mut u32,
    first: *mut u32,
    count: *mut u32,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_font_glyph(code: u32, out: *mut u8, out_len: usize) -> i32 {
    if out.is_null() {
        return font_status_code(font::Status::NullArgument);
    }
...
static UI_FONT: &[u8] = include_bytes!(env!("OPENGAT_UI_FONT_BLOB"));
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_ui_font_geometry(metrics: *mut ui_font::Geometry) -> i32 {
    if metrics.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_ui_font_glyph(code: u32, out: *mut u8, out_len: usize) -> i32 {
    if out.is_null() {
        return ui_font_status_code(ui_font::Status::NullArgument);
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_ui_font_glyph_advance(code: u32, out: *mut u32) -> i32 {
    if out.is_null() {
        return ui_font_status_code(ui_font::Status::NullArgument);
    }
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_fat32_parse_bpb(
    block: *const u8,
    block_len: usize,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_fat32_parse_fsinfo(
    block: *const u8,
    block_len: usize,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_fat32_validate_fat_pair(
    first: *const u8,
    first_len: usize,
    second: *const u8,
    second_len: usize,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_fat32_classify_cluster(
    value: u32,
    geometry: *const fat32::Geometry,
    out: *mut u32,
) -> i32 {
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_fat32_parse_component(
    component: *const u8,
    component_len: usize,
    out: *mut fat32::Name,
) -> i32 {
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_fat32_validate_path(
    path: *const u8,
    path_len: usize,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn opengat_fat32_parse_directory_entry(
    entry: *const u8,
    entry_len: usize,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_fat16_parse_bpb(
    block: *const u8,
    block_len: usize,
    namespace_blocks: u64,
    namespace_block_bytes: u32,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_fat16_make_query(
    name: *const u8,
    name_len: usize,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_fat16_find_root(
    block: *const u8,
    block_len: usize,
...
/// overlap the output.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_fat16_parse_fat(
    block: *const u8,
    block_len: usize,
    geometry: *const fat16::Geometry,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_fat16_validate_extent(
    geometry: *const fat16::Geometry,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_fat16_validate_payload(
    data: *const u8,
    data_len: usize,
...
#[unsafe(no_mangle)]
pub extern "C" fn opengat_linux_fat16_self_test() -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_fat16_make_query(out: *mut fat16::RootQuery) -> i32 {
    if out.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_fat16_find_root(
    block: *const u8,
    block_len: usize,
    geometry: *const fat16::Geometry,
    query: *const fat16::RootQuery,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_fat16_build_chain(
    fat_block: *const u8,
    fat_len: usize,
    geometry: *const fat16::Geometry,
    entry: *const fat16::RootEntry,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_fat16_validate_payload(
    data: *const u8,
    data_len: usize,
...
#[unsafe(no_mangle)]
pub extern "C" fn opengat_linux_uname_fat16_self_test() -> u32 {
...
/// `out` must address one writable root query.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_uname_fat16_make_query(out: *mut fat16::RootQuery) -> i32 {
    if out.is_null() {
        return linux_fat16_status_code(linux_fat16::Status::NullArgument);
    }
    // SAFETY: the caller promises one writable RootQuery and null was refused.
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_uname_fat16_find_root(
    block: *const u8,
    block_len: usize,
    geometry: *const fat16::Geometry,
    query: *const fat16::RootQuery,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_uname_fat16_build_chain(
    fat_block: *const u8,
    fat_len: usize,
    geometry: *const fat16::Geometry,
    entry: *const fat16::RootEntry,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_uname_fat16_validate_payload(
    data: *const u8,
    data_len: usize,
    out: *mut linux_fat16::Payload,
) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn opengat_linux_cat_fat16_self_test() -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_cat_fat16_make_query(out: *mut fat16::RootQuery) -> i32 {
    if out.is_null() {
        return linux_fat16_status_code(linux_fat16::Status::NullArgument);
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_cat_fat16_find_root(
    block: *const u8,
    block_len: usize,
    geometry: *const fat16::Geometry,
    query: *const fat16::RootQuery,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_cat_fat16_build_chain(
    fat_block: *const u8,
    fat_len: usize,
    geometry: *const fat16::Geometry,
    entry: *const fat16::RootEntry,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_cat_fat16_validate_payload(
    data: *const u8,
    data_len: usize,
    out: *mut linux_fat16::Payload,
) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn opengat_native_image_self_test() -> u32 {
    native_image::self_test()
}

/// Run the dynamic-ELF C-layout and checked-address invariants.
#[unsafe(no_mangle)]
pub extern "C" fn opengat_elf64_dynamic_self_test() -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_native_manifest_authenticate(
...
/// result. The ranges must not overlap.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_elf64_dynamic_parse(
    input: *const u8,
    input_length: usize,
...
/// result.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_elf64_dynamic_catalog_authenticate(
    input: *const u8,
    input_length: usize,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_elf64_dynamic_object_authenticate(
    input: *const u8,
    input_length: usize,
    expected_sha256: *const u8,
    image_out: *mut elf64_dynamic::Image,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_elf64_dynamic_dependency_order(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_elf64_dynamic_relocate_scope(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_elf64_dynamic_lifecycle(
    objects: *const elf64_dynamic::PreparedObject,
    object_count: usize,
...
/// # Safety
///
/// `image` must name one result returned by `opengat_elf64_dynamic_parse`,
/// `input` its unchanged complete file, and `memory` an exactly sized writable
/// preparation range. The ranges must not overlap.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_elf64_dynamic_prepare(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_native_image_validate(
    manifest_bytes: *const u8,
    manifest_length: usize,
    elf_bytes: *const u8,
    elf_length: usize,
...
#[unsafe(no_mangle)]
pub extern "C" fn opengat_linux_elf64_self_test() -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_elf64_parse(
    input: *const u8,
    input_len: usize,
...
#[unsafe(no_mangle)]
pub extern "C" fn opengat_linux_uname_elf64_self_test() -> u32 {
...
/// writable validated image. The ranges must not overlap.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_uname_elf64_parse(
    input: *const u8,
    input_len: usize,
    out: *mut linux_elf64::ValidatedImage,
) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn opengat_linux_cat_elf64_self_test() -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_linux_cat_elf64_parse(
    input: *const u8,
    input_len: usize,
    out: *mut linux_elf64::ValidatedImage,
) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn opengat_elf64_self_test() -> u32 {
    elf64::self_test()
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_elf64_parse(
    input: *const u8,
    input_len: usize,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_nvbios_reference(
    out: *mut u8,
    capacity: usize,
) -> usize {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_nvbios_parse(
    input: *const u8,
    input_len: usize,
...
/// address one writable `elf64::ValidatedImage`.  The ranges must not overlap.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn opengat_multiprocess_elf64_parse(
    input: *const u8,
    input_len: usize,
    out: *mut elf64::ValidatedImage,
) -> i32 {

 ...
 *
 * This is the first Trait OS driver whose device writes into kernel memory for
 * something other than storage or networking, and the ordering that makes that
 * safe is the whole point of the file. Trait OS has no IOMMU. A device with bus

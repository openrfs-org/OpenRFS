...
)
{
    ...
    /*
     * First normalize any crash-leftover candidate without ever removing the
     * only copy of the greatest accepted floor. A greater/equal new record is
     * promoted while it still exists; a lower duplicate is discarded only
     * while the authoritative record remains present.
     */

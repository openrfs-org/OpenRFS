...
static uint8_t multiprocess_sentinel[MULTIPROCESS_SENTINEL_BYTES] = {
    0x54, 0x52, 0x41, 0x49, 0x54, 0x2D, 0x4D, 0x55,
    0x4C, 0x54, 0x49, 0x50, 0x52, 0x4F, 0x43, 0x45,
    0x53, 0x53, 0x2D, 0x53, 0x45, 0x4E, 0x54, 0x49,
    0x4E, 0x45, 0x4C, 0x2D, 0x52, 0x33, 0x30, 0x30
};
...
)
{
    ...
    if (trait_multiprocess_elf64_parse(multiprocess_image,
...
bool multiprocess_foundation_self_test(size_t *completed_tests)
{
    ...
    *completed_tests = 0U;
    ...
    ++completed;
    if (trait_multiprocess_elf64_self_test() !=
    ...
    if (trait_multiprocess_elf64_parse(multiprocess_image,
        ...
        trait_elf64_parse(multiprocess_image, sizeof(multiprocess_image),

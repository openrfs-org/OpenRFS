...
/*
 * Trait OS policy bound on the shortest deadline that may be armed. The local APIC
...
/*
 * Trait OS policy bound on a sleep. A deadline that has not arrived by twice its

...
/*
 * Trait OS policy bound, not an ACPI limit. One wait may not ask for more than a
...
/*
 * Trait OS policy bound on the spin. Each iteration is one 32-bit port read of

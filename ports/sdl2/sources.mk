...
# SDL 2.32.10 common sources plus Trait OS's public-ABI platform backends.

SDL2_SOURCES := \
	$(wildcard vendor/sdl2/src/*.c) \
	$(wildcard vendor/sdl2/src/atomic/*.c) \
	$(wildcard vendor/sdl2/src/audio/*.c) \
	$(wildcard vendor/sdl2/src/audio/trait/*.c) \
	...
	$(wildcard vendor/sdl2/src/filesystem/trait/*.c) \
	...
	$(wildcard vendor/sdl2/src/thread/trait/*.c) \
	$(wildcard vendor/sdl2/src/timer/*.c) \
	$(wildcard vendor/sdl2/src/timer/trait/*.c) \
	$(wildcard vendor/sdl2/src/video/*.c) \
	$(wildcard vendor/sdl2/src/video/yuv2rgb/*.c) \
	$(wildcard vendor/sdl2/src/video/trait/*.c)

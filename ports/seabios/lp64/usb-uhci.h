...
// specification defines. Upstream declares it void *, which is four bytes
// only in SeaBIOS's own 32-bit builds; in an LP64 build it made every
// transfer descriptor 20 bytes, so the second descriptor of a transfer
// began inside the first one's buffer field.
//
// Like the file it copies, this file may be distributed under the terms of

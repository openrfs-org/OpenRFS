...
{
    register uint64_t number __asm__("rax") = OPENGAT_SYS_CONSOLE_WRITE;
...
{
    static const char marker[] = "OPENGAT DYNAMIC ROOT INIT\n";
...
{
    static const char marker[] = "OPENGAT DYNAMIC ROOT FINI\n";
...
{
    static const char pass[] = "OPENGAT DYNAMIC RING3 PASS\n";
    static const char fail[] = "OPENGAT DYNAMIC RING3 FAIL\n";

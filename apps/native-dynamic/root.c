...
{
    register uint64_t number __asm__("rax") = TRAIT_SYS_CONSOLE_WRITE;
...
{
    static const char marker[] = "TRAIT DYNAMIC ROOT INIT\n";
...
{
    static const char marker[] = "TRAIT DYNAMIC ROOT FINI\n";
...
{
    static const char pass[] = "TRAIT DYNAMIC RING3 PASS\n";
    static const char fail[] = "TRAIT DYNAMIC RING3 FAIL\n";

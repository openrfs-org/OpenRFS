...
{
    register uint64_t number __asm__("rax") = OPENRFS_SYS_CONSOLE_WRITE;
...
{
    static const char marker[] = "OPENRFS DYNAMIC ROOT INIT\n";
...
{
    static const char marker[] = "OPENRFS DYNAMIC ROOT FINI\n";
...
{
    static const char pass[] = "OPENRFS DYNAMIC RING3 PASS\n";
    static const char fail[] = "OPENRFS DYNAMIC RING3 FAIL\n";

...
#ifndef OPENRFS_SCREEN_H
#define OPENRFS_SCREEN_H
 ...
 *
 * Until this existed, OpenRFS could draw pixels and could write words, but not
...
/*
 * OpenRFS borrows the one long-lived cached surface and constrains this

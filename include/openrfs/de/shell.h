...
#ifndef OPENRFS_DE_SHELL_H
#define OPENRFS_DE_SHELL_H

#include <stdbool.h>
#include <stdint.h>

#include <openrfs/de/input.h>
...
#define OPENRFS_SHELL_MAX_WINDOWS 8U
 ...
 */
#define OPENRFS_SHELL_FIRST_PID 2U

enum openrfs_shell_app {
    OPENRFS_APP_FILES = 0,
    OPENRFS_APP_TERMINAL,
    OPENRFS_APP_TASKMGR,
    OPENRFS_APP_SETTINGS,
    OPENRFS_APP_PACKAGES,
    OPENRFS_APP_COUNT
};
 ...
 * openrfs_shell_reset(), and settable on its own because the two are not
 ...
 * names openrfs_files_rename() refuses, out loud. */
 ...
 */
#define OPENRFS_SHELL_MAX_NOTES 3U
#define OPENRFS_SHELL_NOTE_BYTES 64U
 ...
 */
#define OPENRFS_SHELL_TIP_TICKS 5U
...
/* Returns the slot, or OPENRFS_SHELL_MAX_WINDOWS if there is no room. */
...
/* The window under a point, topmost first, or OPENRFS_SHELL_MAX_WINDOWS. */
 ...
 */
typedef bool (*openrfs_event_source)(struct openrfs_event *out, void *context);
typedef void (*openrfs_present_fn)(void *context);

 ...
 * openrfs/ui.h - is one fixed 18x25 bitmap with one fixed hotspot, and there
 ...
 * platform's pointer shows.  That is patch work in OpenRFS's own ui.c/ui.h,
 ...
 */
#ifndef OPENRFS_CURSOR_H
#define OPENRFS_CURSOR_H

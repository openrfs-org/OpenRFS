...
#ifndef OPENRFS_KEYBOARD_H
#define OPENRFS_KEYBOARD_H
 ...
 *
 * This is the first device OpenRFS talks to that a person operates. Everything
...
/*
 * One key event. OpenRFS reports both presses and releases rather than only the

...
#ifndef OPENRFS_FONT_H
#define OPENRFS_FONT_H
 ...
 * printed, so this is the first Rust in OpenRFS on a hot path.
 *
 ...
 * buffer a caller must offer openrfs_font_glyph. src/rust/font.rs refuses
 ...
 */
int32_t openrfs_font_glyph(uint32_t code, uint8_t *out, size_t out_len);

...
#ifndef OPENRFS_BOOT_LEDGER_H
#define OPENRFS_BOOT_LEDGER_H
...
/*
 * OpenRFS's boot graph and its evidence are deliberately bounded. Neither
...
#define BOOT_LEDGER_STAGE_CAPACITY 59U
#define BOOT_LEDGER_RECEIPT_CAPACITY 59U
...
enum boot_stage_id {
    ...
    BOOT_STAGE_DRIVER_FRAMEWORK_FOUNDATION,
    BOOT_STAGE_DRIVER_FRAMEWORK_BIND,
    BOOT_STAGE_COUNT
};

...
#ifndef OPENRFS_FAT32_H
#define OPENRFS_FAT32_H
...
enum fat32_status openrfs_fat32_parse_bpb(
    const uint8_t *block,
    size_t block_len,
...
enum fat32_status openrfs_fat32_parse_fsinfo(
    const uint8_t *block,
    size_t block_len,
    const struct fat32_geometry *geometry,
    struct fat32_fsinfo *out
);
enum fat32_status openrfs_fat32_validate_fat_pair(
    const uint8_t *first,
    size_t first_len,
...
enum fat32_status openrfs_fat32_classify_cluster(
    uint32_t value,
    const struct fat32_geometry *geometry,
    uint32_t *out
);
enum fat32_status openrfs_fat32_parse_component(
    const uint8_t *component,
    size_t component_len,
    struct fat32_name *out
);
enum fat32_status openrfs_fat32_validate_path(
    const uint8_t *path,
    size_t path_len,
    uint32_t *component_count
);
enum fat32_status openrfs_fat32_parse_directory_entry(
    const uint8_t *entry,
    size_t entry_len,

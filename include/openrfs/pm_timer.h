...
#ifndef OPENRFS_PM_TIMER_H
#define OPENRFS_PM_TIMER_H
 ...
 * original PC clock chain was built from. OpenRFS does not measure this rate
...
/*
 * OpenRFS agreement policy, not an ACPI rule. Two measurements of one interval

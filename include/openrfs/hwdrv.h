 ...
 * real machines for years (iPXE's network drivers and USB stack, SeaBIOS's
 * storage, USB, display and TPM drivers, MINIX 3's sound drivers), compiled
 * against small compatibility layers that give them the environment they
 * were written for.
 *

...
#ifndef OPENRFS_THREAD_H
#define OPENRFS_THREAD_H
...
/*
 * An OpenRFS policy bound on how many threads may exist at once, not an
 ...
 * error against it. It is an OpenRFS policy number, not an architectural one.
 */

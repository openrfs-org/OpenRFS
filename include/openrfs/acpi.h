...
#ifndef OPENRFS_ACPI_H
#define OPENRFS_ACPI_H
...
/*
 * An OpenRFS early-boot policy bound on how many configuration windows firmware
 * may declare, not an architectural one. Every machine OpenRFS is tested on
...
/*
 * The fixed ACPI description table, reduced to the one facility OpenRFS uses
...
/*
 * OpenRFS early-boot policy bounds on firmware-declared topology. They keep the

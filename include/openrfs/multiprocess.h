...
#ifndef OPENRFS_MULTIPROCESS_H
#define OPENRFS_MULTIPROCESS_H
...
uint32_t openrfs_multiprocess_elf64_self_test(void);
enum elf64_status openrfs_multiprocess_elf64_parse(
    const uint8_t *input,
    size_t input_len,

...
#ifndef OPENRFS_PCI_H
#define OPENRFS_PCI_H
 ...
 * present on every PC since PCI existed. It is what OpenRFS enumerates through.
 */
...
/*
 * An OpenRFS early-boot policy bound on how many functions one enumeration may

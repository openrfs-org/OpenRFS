...
#ifndef OPENRFS_LINUX_ELF64_H
#define OPENRFS_LINUX_ELF64_H
...
uint32_t openrfs_linux_elf64_self_test(void);
enum linux_elf64_status openrfs_linux_elf64_parse(
    const uint8_t *input,
    size_t input_len,
    struct linux_elf64_validated_image *out
);
uint32_t openrfs_linux_uname_elf64_self_test(void);
enum linux_elf64_status openrfs_linux_uname_elf64_parse(
    const uint8_t *input,
    size_t input_len,
    struct linux_elf64_validated_image *out
);
uint32_t openrfs_linux_cat_elf64_self_test(void);
enum linux_elf64_status openrfs_linux_cat_elf64_parse(
    const uint8_t *input,
    size_t input_len,
    struct linux_elf64_validated_image *out
);

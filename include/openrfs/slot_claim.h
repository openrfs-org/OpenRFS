...
#ifndef OPENRFS_SLOT_CLAIM_H
#define OPENRFS_SLOT_CLAIM_H
...
static inline size_t openrfs_slot_claim(bool *claims, size_t capacity)
{
...
static inline void openrfs_slot_release(bool *claims, size_t index)
{

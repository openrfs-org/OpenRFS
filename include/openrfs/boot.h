...
#ifndef OPENRFS_BOOT_H
#define OPENRFS_BOOT_H
 ...
 */
#define OPENRFS_EARLY_PHYSICAL_LIMIT UINT64_C(0x100000000)
 ...
 * same tag, and OpenRFS refuses each by name rather than guessing.
 */

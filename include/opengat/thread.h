...
#ifndef OPENGAT_THREAD_H
#define OPENGAT_THREAD_H
...
/*
 * A OpenGAT policy bound on how many threads may exist at once, not an
 ...
 * error against it. It is a OpenGAT policy number, not an architectural one.
 */

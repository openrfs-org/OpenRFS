...
#ifndef OPENGAT_KEYBOARD_H
#define OPENGAT_KEYBOARD_H
 ...
 *
 * This is the first device OpenGAT talks to that a person operates. Everything
...
/*
 * One key event. OpenGAT reports both presses and releases rather than only the

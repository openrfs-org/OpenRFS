...
#ifndef OPENGAT_AUDIO_H
#define OPENGAT_AUDIO_H
...
/*
 * The first OpenGAT driver that lets a device write into kernel memory on its
 ...
 * DMA. OpenGAT has no IOMMU, so a device that can write one ring can write

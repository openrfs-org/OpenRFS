...
#ifndef OPENGAT_FONT_H
#define OPENGAT_FONT_H
 ...
 * printed, so this is the first Rust in OpenGAT on a hot path.
 *
 ...
 * buffer a caller must offer opengat_font_glyph. src/rust/font.rs refuses
 ...
 */
int32_t opengat_font_glyph(uint32_t code, uint8_t *out, size_t out_len);

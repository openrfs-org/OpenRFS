...
#ifndef OPENGAT_MULTIPROCESS_H
#define OPENGAT_MULTIPROCESS_H
...
uint32_t opengat_multiprocess_elf64_self_test(void);
enum elf64_status opengat_multiprocess_elf64_parse(
    const uint8_t *input,
    size_t input_len,

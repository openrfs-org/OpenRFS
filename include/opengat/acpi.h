...
#ifndef OPENGAT_ACPI_H
#define OPENGAT_ACPI_H
...
/*
 * A OpenGAT early-boot policy bound on how many configuration windows firmware
 * may declare, not an architectural one. Every machine OpenGAT is tested on
...
/*
 * The fixed ACPI description table, reduced to the one facility OpenGAT uses
...
/*
 * OpenGAT early-boot policy bounds on firmware-declared topology. They keep the

...
#ifndef OPENGAT_PACKAGE_PLATFORM_TRUST_H
#define OPENGAT_PACKAGE_PLATFORM_TRUST_H
...
extern const uint8_t opengat_package_trust_asset[];
extern const size_t opengat_package_trust_asset_bytes;

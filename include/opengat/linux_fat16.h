...
#ifndef OPENGAT_LINUX_FAT16_H
#define OPENGAT_LINUX_FAT16_H
...
enum linux_fat16_status opengat_linux_fat16_find_root(
    const uint8_t *block,
    size_t block_len,
...
enum linux_fat16_status opengat_linux_fat16_make_query(
    struct fat16_root_query *out
);
enum linux_fat16_status opengat_linux_fat16_build_chain(
    const uint8_t *fat,
    size_t fat_len,
    const struct fat16_geometry *geometry,
...
enum linux_fat16_status opengat_linux_fat16_validate_payload(
    const uint8_t *data,
    size_t data_len,
    struct linux_fat16_payload *out
);
uint32_t opengat_linux_fat16_self_test(void);
enum linux_fat16_status opengat_linux_uname_fat16_find_root(
    const uint8_t *block,
    size_t block_len,
    const struct fat16_geometry *geometry,
    const struct fat16_root_query *query,
...
enum linux_fat16_status opengat_linux_uname_fat16_make_query(
    struct fat16_root_query *out
);
enum linux_fat16_status opengat_linux_uname_fat16_build_chain(
    const uint8_t *fat,
    size_t fat_len,
    const struct fat16_geometry *geometry,
    const struct fat16_root_entry *entry,
...
enum linux_fat16_status opengat_linux_uname_fat16_validate_payload(
    const uint8_t *data,
    size_t data_len,
    struct linux_fat16_payload *out
);
uint32_t opengat_linux_uname_fat16_self_test(void);
enum linux_fat16_status opengat_linux_cat_fat16_find_root(
    const uint8_t *block,
    size_t block_len,
    const struct fat16_geometry *geometry,
    const struct fat16_root_query *query,
...
enum linux_fat16_status opengat_linux_cat_fat16_make_query(
    struct fat16_root_query *out
);
enum linux_fat16_status opengat_linux_cat_fat16_build_chain(
    const uint8_t *fat,
    size_t fat_len,
    const struct fat16_geometry *geometry,
    const struct fat16_root_entry *entry,
...
enum linux_fat16_status opengat_linux_cat_fat16_validate_payload(
    const uint8_t *data,
    size_t data_len,
    struct linux_fat16_payload *out
);
uint32_t opengat_linux_cat_fat16_self_test(void);

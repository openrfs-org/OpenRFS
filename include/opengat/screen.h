...
#ifndef OPENGAT_SCREEN_H
#define OPENGAT_SCREEN_H
 ...
 *
 * Until this existed, OpenGAT could draw pixels and could write words, but not
...
/*
 * OpenGAT borrows the one long-lived cached surface and constrains this

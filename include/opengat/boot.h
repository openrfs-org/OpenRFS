...
#ifndef OPENGAT_BOOT_H
#define OPENGAT_BOOT_H
 ...
 */
#define OPENGAT_EARLY_PHYSICAL_LIMIT UINT64_C(0x100000000)
 ...
 * same tag, and OpenGAT refuses each by name rather than guessing.
 */

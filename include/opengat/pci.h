...
#ifndef OPENGAT_PCI_H
#define OPENGAT_PCI_H
 ...
 * present on every PC since PCI existed. It is what OpenGAT enumerates through.
 */
...
/*
 * A OpenGAT early-boot policy bound on how many functions one enumeration may

...
#ifndef OPENGAT_LINUX_ELF64_H
#define OPENGAT_LINUX_ELF64_H
...
uint32_t opengat_linux_elf64_self_test(void);
enum linux_elf64_status opengat_linux_elf64_parse(
    const uint8_t *input,
    size_t input_len,
    struct linux_elf64_validated_image *out
);
uint32_t opengat_linux_uname_elf64_self_test(void);
enum linux_elf64_status opengat_linux_uname_elf64_parse(
    const uint8_t *input,
    size_t input_len,
    struct linux_elf64_validated_image *out
);
uint32_t opengat_linux_cat_elf64_self_test(void);
enum linux_elf64_status opengat_linux_cat_elf64_parse(
    const uint8_t *input,
    size_t input_len,
    struct linux_elf64_validated_image *out
);

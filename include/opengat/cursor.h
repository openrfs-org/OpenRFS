 ...
 * opengat/ui.h - is one fixed 18x25 bitmap with one fixed hotspot, and there
 ...
 * platform's pointer shows.  That is patch work in OpenGAT's own ui.c/ui.h,
 ...
 */
#ifndef OPENGAT_CURSOR_H
#define OPENGAT_CURSOR_H

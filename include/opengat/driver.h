...
#ifndef OPENGAT_DRIVER_H
#define OPENGAT_DRIVER_H
 ...
 *
 * OpenGAT already drives three controllers - xHCI, NVMe and virtio-net - and
 ...
 * OpenGAT has no IOMMU; a driver that only reads registers is a driver that

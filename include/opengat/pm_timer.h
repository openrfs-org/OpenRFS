...
#ifndef OPENGAT_PM_TIMER_H
#define OPENGAT_PM_TIMER_H
 ...
 * original PC clock chain was built from. OpenGAT does not measure this rate
...
/*
 * OpenGAT agreement policy, not an ACPI rule. Two measurements of one interval

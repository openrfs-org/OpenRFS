 ...
 * trait/ui.h - is one fixed 18x25 bitmap with one fixed hotspot, and there
 ...
 * platform's pointer shows.  That is patch work in Trait OS's own ui.c/ui.h,
 ...
 */
#ifndef TRAIT_CURSOR_H
#define TRAIT_CURSOR_H

...
#ifndef TRAIT_THREAD_H
#define TRAIT_THREAD_H
...
/*
 * A Trait OS policy bound on how many threads may exist at once, not an
 ...
 * error against it. It is a Trait OS policy number, not an architectural one.
 */

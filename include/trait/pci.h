 ...
 * present on every PC since PCI existed. It is what Trait OS enumerates through.
 */
...
/*
 * A Trait OS early-boot policy bound on how many functions one enumeration may

...
/*
 * A Trait OS early-boot policy bound on how many configuration windows firmware
 * may declare, not an architectural one. Every machine Trait OS is tested on
...
/*
 * The fixed ACPI description table, reduced to the one facility Trait OS uses
...
/*
 * Trait OS early-boot policy bounds on firmware-declared topology. They keep the

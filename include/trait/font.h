 ...
 * printed, so this is the first Rust in Trait OS on a hot path.
 *
 ...
 * buffer a caller must offer trait_font_glyph. src/rust/font.rs refuses
 ...
 */
int32_t trait_font_glyph(uint32_t code, uint8_t *out, size_t out_len);

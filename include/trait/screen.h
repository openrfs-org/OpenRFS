...
#ifndef TRAIT_SCREEN_H
#define TRAIT_SCREEN_H
 ...
 *
 * Until this existed, Trait OS could draw pixels and could write words, but not
...
/*
 * Trait OS borrows the one long-lived cached surface and constrains this

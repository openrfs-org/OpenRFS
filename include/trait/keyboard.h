...
#ifndef TRAIT_KEYBOARD_H
#define TRAIT_KEYBOARD_H
 ...
 *
 * This is the first device Trait OS talks to that a person operates. Everything
...
/*
 * One key event. Trait OS reports both presses and releases rather than only the

...
#ifndef TRAIT_DRIVER_H
#define TRAIT_DRIVER_H
 ...
 *
 * Trait OS already drives three controllers - xHCI, NVMe and virtio-net - and
 ...
 * Trait OS has no IOMMU; a driver that only reads registers is a driver that

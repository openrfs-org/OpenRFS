...
#ifndef TRAIT_AUDIO_H
#define TRAIT_AUDIO_H
...
/*
 * The first Trait OS driver that lets a device write into kernel memory on its
 ...
 * DMA. Trait OS has no IOMMU, so a device that can write one ring can write

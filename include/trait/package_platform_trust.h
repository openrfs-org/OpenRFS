...
#ifndef TRAIT_PACKAGE_PLATFORM_TRUST_H
#define TRAIT_PACKAGE_PLATFORM_TRUST_H
...
extern const uint8_t trait_package_trust_asset[];
extern const size_t trait_package_trust_asset_bytes;

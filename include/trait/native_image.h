...
#ifndef TRAIT_NATIVE_IMAGE_H
#define TRAIT_NATIVE_IMAGE_H
...
enum native_image_status trait_native_image_validate(
...
enum native_image_status trait_native_manifest_authenticate(
    const uint8_t *manifest_bytes,
    size_t manifest_length,
    const uint8_t *elf_bytes,
    size_t elf_length,
...
uint32_t trait_native_image_self_test(void);

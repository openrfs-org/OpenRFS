...
#ifndef TRAIT_MULTIPROCESS_H
#define TRAIT_MULTIPROCESS_H
...
uint32_t trait_multiprocess_elf64_self_test(void);
enum elf64_status trait_multiprocess_elf64_parse(
    const uint8_t *input,
    size_t input_len,

...
#ifndef TRAIT_PM_TIMER_H
#define TRAIT_PM_TIMER_H
 ...
 * original PC clock chain was built from. Trait OS does not measure this rate
...
/*
 * Trait OS agreement policy, not an ACPI rule. Two measurements of one interval

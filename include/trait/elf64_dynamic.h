...
#ifndef TRAIT_ELF64_DYNAMIC_H
#define TRAIT_ELF64_DYNAMIC_H
...
enum elf64_dynamic_status trait_elf64_dynamic_parse(
    const uint8_t *input,
    size_t input_length,
    struct elf64_dynamic_image *image
);
enum elf64_dynamic_status trait_elf64_dynamic_prepare(
    const struct elf64_dynamic_image *image,
    const uint8_t *input,
    size_t input_length,
    uint8_t *memory,
...
enum elf64_dynamic_status trait_elf64_dynamic_catalog_authenticate(
    const uint8_t *input,
    size_t input_length,
    const uint8_t expected_sha256[32],
    struct elf64_dynamic_catalog *catalog
);
enum elf64_dynamic_status trait_elf64_dynamic_object_authenticate(
    const uint8_t *input,
    size_t input_length,
    const uint8_t expected_sha256[32],
    struct elf64_dynamic_image *image
);
enum elf64_dynamic_status trait_elf64_dynamic_dependency_order(
...
enum elf64_dynamic_status trait_elf64_dynamic_relocate_scope(
    const struct elf64_dynamic_prepared_object *objects,
    size_t object_count
);
enum elf64_dynamic_status trait_elf64_dynamic_lifecycle(
    const struct elf64_dynamic_prepared_object *objects,
    size_t object_count,
    struct elf64_dynamic_lifecycle *lifecycle
);
uint32_t trait_elf64_dynamic_self_test(void);

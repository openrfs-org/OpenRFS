#!/usr/bin/env python3
"""Build, inspect, and install deterministic Trait OS application packages."""
...
PACKAGE_MAGIC = b"TRTPKG01"
MANIFEST_MAGIC = b"TRAITAPP"
V3_HEADER_BYTES = 512
...
def inspect_dynamic_catalog(report: dict[str, Any],
    ...
    if len(catalog) != 2048 or catalog[:8] != b"TRTDYN01":
...
def main() -> int:
    try:
        ...
        print(f"Trait OS package refused: {error}", file=sys.stderr)
        return 1
    return 0

...
"$cc" "${cflags[@]}" -c "$root/ports/sqlite/opengat_vfs.c" \
    -o "$work/obj/opengat_vfs.o"
...
"$ld" -nostdlib -static --gc-sections --build-id=none \
    ...
    "$work/obj/opengat_vfs.o" "$work/obj/main.o" "$sdk/lib/libopengat.a"

echo "SQLite 3.46.0 OpenGAT executable: $output/SQLITE.APP"

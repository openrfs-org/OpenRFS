...
"$cc" "${cflags[@]}" -c "$root/ports/sqlite/trait_vfs.c" \
    -o "$work/obj/trait_vfs.o"
...
"$ld" -nostdlib -static --gc-sections --build-id=none \
    ...
    "$work/obj/trait_vfs.o" "$work/obj/main.o" "$sdk/lib/libtrait.a"

echo "SQLite 3.46.0 Trait OS executable: $output/SQLITE.APP"

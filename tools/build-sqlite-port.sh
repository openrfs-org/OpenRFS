...
sdk="$root/build/sdk"
cc=${OPENRFS_SDK_CC:-clang}
ld=${OPENRFS_SDK_LD:-ld.lld}
...
"$cc" "${cflags[@]}" -c "$root/ports/sqlite/openrfs_vfs.c" \
    -o "$work/obj/openrfs_vfs.o"
...
"$ld" -nostdlib -static --gc-sections --build-id=none \
    ...
    "$work/obj/openrfs_vfs.o" "$work/obj/main.o" "$sdk/lib/libopenrfs.a"

echo "SQLite 3.46.0 OpenRFS executable: $output/SQLITE.APP"

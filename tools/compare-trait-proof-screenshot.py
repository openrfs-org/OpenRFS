...
"""Compare actual Trait OS QEMU frames using bounded stable regions."""
...
# Trait OS exposes no timing, addresses, counters, or other variable fields
...
def compare_pixels(reference, candidate, mode):
    ...
    return True, "all stable Trait OS pixels match"

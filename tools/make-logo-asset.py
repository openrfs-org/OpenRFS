...
"""Turn assets/opengat/logo.png into the run-length asset the kernel draws.
...
Run it only when the logo itself changes:
    ...
    python3 tools/make-logo-asset.py assets/opengat/logo.png 280 build/logo.srl
...
def main():
    source = sys.argv[1] if len(sys.argv) > 1 else 'assets/opengat/logo.png'

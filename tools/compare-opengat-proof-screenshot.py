...
"""Compare actual OpenGAT QEMU frames using bounded stable regions."""
...
# OpenGAT exposes no timing, addresses, counters, or other variable fields
...
def compare_pixels(reference, candidate, mode):
    ...
    return True, "all stable OpenGAT pixels match"

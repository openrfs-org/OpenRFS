...
"""Compare actual OpenRFS QEMU frames using bounded stable regions."""
...
# OpenRFS exposes no timing, addresses, counters, or other variable fields
...
def compare_pixels(reference, candidate, mode):
    ...
    return True, "all stable OpenRFS pixels match"

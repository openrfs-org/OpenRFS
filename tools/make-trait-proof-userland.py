...
FIRST_DATA_SECTOR = 4
MEDIA = 0xF8
IMAGE_SHA256 = "ACA66204CEA82B1BBF11CE51A31F934C5F2486ED14F6B613F0A1DE07BFCFB475"
NO_CAT_IMAGE_SHA256 = "9E19035320ACC718FB9AC1AC1C14EA211E71A8E71662A35FF38DA543365A5D17"
    ...
    try:
        ...
        if output is not None:
            try:
                ...
                pass
        print(f"Trait OS userspace volume refused: {error}", file=sys.stderr)
        return 1
    print(

#!/usr/bin/env python3
"""Build, verify, and resolve deterministic signed OpenRFS repository indexes."""
...
PACKAGE_TOOL_SPEC = importlib.util.spec_from_file_location(
    "openrfs_repository_package_tool", PACKAGE_TOOL_PATH)
...
def main() -> int:
    try:
        ...
        print(f"OpenRFS repository refused: {error}", file=sys.stderr)
        return 1
    return 0

...
FIRST_DATA_SECTOR = 4
MEDIA = 0xF8
IMAGE_SHA256 = "234289FCC58E498AA18A68B5BFF00E9F81940211CAAF2507B81CB65155EBE975"
NO_CAT_IMAGE_SHA256 = "CE3BD25E1776291D18D0CC75F044DD040243A5DB2CD50C902F747F35E76C5F3D"
...
def main() -> int:
    ...
    try:
        ...
        input_paths = {echo_path.resolve(), uname_path.resolve()}
        if cat_path is not None:
            input_paths.add(cat_path.resolve())
        if output.resolve(strict=False) in input_paths:
            raise ValueError("userspace volume output must differ from its inputs")
        ...
        if output is not None:
            try:
                ...
                pass
        print(f"OpenGAT userspace volume refused: {error}", file=sys.stderr)
        return 1
    print(

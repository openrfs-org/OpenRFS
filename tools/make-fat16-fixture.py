#!/usr/bin/env python3
"""Build and independently verify OpenGAT's bounded FAT16 QEMU fixture."""
...
FILE_BYTES = 128
MEDIA = 0xF8
SHORT_NAME = b"OPENGAT BIN"
PAYLOAD_SHA256 = "D399F065C9F21E2FD51E2AEADB7768EAB7E6E45E5150F31227C9711934A4D1D3"
IMAGE_SHA256 = "A34664FB5A9A4D125E3AEF5AB655046C88937F88D8159BD773AD225D8B4617CA"
...
def main() -> int:
    ...
    print(
        ...
        f"OPENGAT.BIN {FILE_BYTES} bytes, SHA-256 {PAYLOAD_SHA256}, "

#!/usr/bin/env python3
"""Build and independently verify OpenRFS's bounded FAT16 QEMU fixture."""
...
FILE_BYTES = 128
MEDIA = 0xF8
SHORT_NAME = b"OPENRFS BIN"
PAYLOAD_SHA256 = "D399F065C9F21E2FD51E2AEADB7768EAB7E6E45E5150F31227C9711934A4D1D3"
IMAGE_SHA256 = "34A217787FD60E7C528DEF6E2B4F280A5011465A736730A50FE8FA85845D86A5"
...
def main() -> int:
    ...
    print(
        ...
        f"OPENRFS.BIN {FILE_BYTES} bytes, SHA-256 {PAYLOAD_SHA256}, "

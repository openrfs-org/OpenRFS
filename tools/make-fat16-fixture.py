#!/usr/bin/env python3
"""Build and independently verify Trait OS's bounded FAT16 QEMU fixture."""
...
FILE_BYTES = 128
MEDIA = 0xF8
SHORT_NAME = b"TRAIT   BIN"
PAYLOAD_SHA256 = "D399F065C9F21E2FD51E2AEADB7768EAB7E6E45E5150F31227C9711934A4D1D3"
IMAGE_SHA256 = "EEA4EB747AFCA172E1252A58FEC80583BA5F105437114173386E4FA3602FD5B6"
...
def main() -> int:
    ...
    print(
        ...
        f"TRAIT.BIN {FILE_BYTES} bytes, SHA-256 {PAYLOAD_SHA256}, "

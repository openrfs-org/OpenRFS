...
"""Record a fixed-duration OpenRFS boot from QEMU's emulated display.
...
CAT_FOREGROUND_LINE = (
    b"RW USERLAND cat foreground launch yielded to OpenRFS"
)
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="openrfs-boot-video-") as work:
        work = Path(work)

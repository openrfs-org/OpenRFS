...
"""Record a fixed-duration OpenGAT boot from QEMU's emulated display.
...
CAT_FOREGROUND_LINE = (
    b"RW USERLAND cat foreground launch yielded to OpenGAT"
)
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="opengat-boot-video-") as work:
        work = Path(work)

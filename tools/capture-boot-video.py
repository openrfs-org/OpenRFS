...
"""Record a fixed-duration Trait OS boot from QEMU's emulated display.
...
CAT_FOREGROUND_LINE = (
    b"RW USERLAND cat foreground launch yielded to Trait OS"
)
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="trait-boot-video-") as work:
        work = Path(work)

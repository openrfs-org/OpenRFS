...
"""Run the OpenGAT BearSSL wrapper against deterministic offline peers."""
...
def main() -> int:
    ...
    run_case(binary, "hostname-mismatch", "valid", "wrong.opengat.test", TLS_HANDSHAKE)
    ...
    print("OpenGAT TLS host tests passed: chain, hostname, time, truncation, deadline, close")
    return 0

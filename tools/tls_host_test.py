...
"""Run the Trait OS BearSSL wrapper against deterministic offline peers."""
...
def main() -> int:
    ...
    run_case(binary, "hostname-mismatch", "valid", "wrong.trait.test", TLS_HANDSHAKE)
    ...
    print("Trait OS TLS host tests passed: chain, hostname, time, truncation, deadline, close")
    return 0

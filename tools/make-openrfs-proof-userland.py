...
FIRST_DATA_SECTOR = 4
MEDIA = 0xF8
IMAGE_SHA256 = "29E49384CBF65B9F54516B875ABE183C69072DF461C76F7F6DD8E497055D4D21"
NO_CAT_IMAGE_SHA256 = "B2AA321D73954E110BA914254E798832684C4F1F7051D63FB4C18AE0CF848E51"
    ...
    try:
        ...
        if output is not None:
            try:
                ...
                pass
        print(f"OpenRFS userspace volume refused: {error}", file=sys.stderr)
        return 1
    print(

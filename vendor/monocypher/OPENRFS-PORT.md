# OpenRFS Monocypher boundary

The retained files are byte-for-byte Monocypher 4.0.3 sources. OpenRFS does not
...
Monocypher intentionally uses the cofactored Ed25519-Zebra equation. OpenRFS's

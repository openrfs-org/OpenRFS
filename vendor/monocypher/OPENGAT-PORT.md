# OpenGAT Monocypher boundary

The retained files are byte-for-byte Monocypher 4.0.3 sources. OpenGAT does not
...
Monocypher intentionally uses the cofactored Ed25519-Zebra equation. OpenGAT's

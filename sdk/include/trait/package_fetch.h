...
#ifndef TRAIT_USER_PACKAGE_FETCH_H
#define TRAIT_USER_PACKAGE_FETCH_H
...
#define TRAIT_PACKAGE_FETCH_SHA256_BYTES 32U
#define TRAIT_PACKAGE_FETCH_MAX_BYTES TRAIT_PACKAGE_UPLOAD_MAX_BYTES

enum trait_package_fetch_status {
    TRAIT_PACKAGE_FETCH_OK = 0,
    TRAIT_PACKAGE_FETCH_ARGUMENT,
    TRAIT_PACKAGE_FETCH_OPEN,
    TRAIT_PACKAGE_FETCH_HTTPS,
    TRAIT_PACKAGE_FETCH_WRITE,
    TRAIT_PACKAGE_FETCH_CLOSE,
    TRAIT_PACKAGE_FETCH_LENGTH,
    TRAIT_PACKAGE_FETCH_DIGEST,
    TRAIT_PACKAGE_FETCH_SYNC,
    TRAIT_PACKAGE_FETCH_PUBLISH,
    TRAIT_PACKAGE_FETCH_UPLOAD_OPEN,
    TRAIT_PACKAGE_FETCH_UPLOAD_SEAL,
    TRAIT_PACKAGE_FETCH_COUNT
};

struct trait_package_fetch_upload_request {
    const char *hostname;
    uint16_t port;
    uint16_t reserved;
    const char *path;
...
struct trait_package_fetch_request {
    const char *hostname;
    uint16_t port;
    uint16_t reserved;
    const char *path;
...
struct trait_package_fetch_report {
    enum trait_https_status https_status;
    int bearssl_error;
    ...
    uint8_t sha256[TRAIT_PACKAGE_FETCH_SHA256_BYTES];
